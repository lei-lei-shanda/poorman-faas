...
func (siw *ServerInterfaceWrapper) ProxyGetMCP(w http.ResponseWriter, r *http.Request) {
	...
	// ------------- Path parameter "service-uuid" -------------
	var serviceUUID openapi_types.UUID

	err = runtime.BindStyledParameterWithOptions("simple", "service-uuid", chi.URLParam(r, "service-uuid"), &serviceUUID, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "service-uuid", Err: err})
		return
	}
